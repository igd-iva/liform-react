    ...
    _createClass(CompatibleDateTime, [{
        ...
        value: function componentDidMount() {
            ...
            if (!this.props.input.value && this.props.schema.default) {
                this.setState({
                    day: (0, _moment.formatDate)(this.props.schema.default, 'YYYY-MM-DD'),
                    time: (0, _moment.formatDate)(this.props.schema.default, 'HH:mm')
                }, function () {
        ...
        value: function onChange(data, key) {
            ...
            this.setState(newState, this.props.input.onChange((0, _moment.formatDate)(this.state.day + " " + this.state.time, "YYYY-MM-DDTHH:mm:00Z")));
        }
    }, {
        key: "render",
