...
var CompatibleDateTime = function (_React$Component) {
    ...
    _createClass(CompatibleDateTime, [{
        ...
        key: "getStaticYearText",
        value: function getStaticYearText() {
        ...
        key: "getStaticTimeText",
        value: function getStaticTimeText() {
            var result = "";
            if (this.state.hour !== null) result += this.state.hour + ":";
            if (this.state.minute !== null) result += this.state.minute + ":";
            if (this.state.second !== null) result += "" + this.state.second;
            return result;
        }
    }, {
        key: "onChangeField",
        value: function onChangeField(field, e) {
            ...
            this.setState(changeset, function () {
                _this3.props.input.onChange(_this3.buildRfc3339DateTime());
            });
        }
    }, {
        key: "onBlur",
