...
var changeValue = function changeValue(checked, item, onChange) {
    var currentValue = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];

    if (checked) {
        if (currentValue.indexOf(checked) === -1) {
            return onChange([].concat(_toConsumableArray(currentValue), [item]));
        }
    } else {
        return onChange(currentValue.filter(function (items) {
            return it === item;
        }));
    }
...
var renderChoice = function renderChoice(field) {
    ...
    var staticClassname = (0, _classnames2.default)(["glyphicon", {"glyphicon-ok": field.input.value}, {"glyphicon-remove": !field.input.value}]);
    var options = field.schema.items.enum;
    var optionNames = field.schema.items.enum_titles || options;
    ...
    return _react2.default.createElement(
        ...
        Object.entries(selectOptions).map(function (_ref) {
            ...
            return field.readOnly ? _react2.default.createElement(
                "p",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", {
                        ...
                        onChange: function onChange(e) {
                            return changeValue(e.target.checked, value, field.input.onChange, field.input.value);
                        }
                    }),
                    name
                )
...
var ChoiceMultipleExpandedWidget = function ChoiceMultipleExpandedWidget(props) {
...
exports.default = ChoiceMultipleExpandedWidget;