    ...
    if (count) {
        return (0, _times4.default)(count, function (idx) {
            return _react2.default.createElement(
                ...
                (0, _renderField2.default)(_extends({}, schema, { showLabel: false }), idx.toString(), readOnly, theme, prefix, context)
            );
        });
    } else {
        return null;
...
var renderInput = function renderInput(field) {
    ...
    return _react2.default.createElement(
        ...
        renderArrayFields(field.fields.length, field.schema.items, field.readOnly, field.theme, field.fieldName, function (idx) {
