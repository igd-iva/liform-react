...
var renderArrayFields = function renderArrayFields(count, schema, readOnly, theme, fieldName, remove, context, swap) {
        ...
        return (0, _times4.default)(count, function (idx) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    idx !== count - 1 && count > 1 && !readOnly ? _react2.default.createElement(
                        "button",
                        {
                    ...
                    idx !== 0 && count > 1 && !readOnly ? _react2.default.createElement(
                        "button",
                        {
                            className: "btn btn-primary",
                            onClick: function onClick(e) {
                    ...
                    !readOnly && (schema.minItems ? count > schema.minItems : true) && _react2.default.createElement(
                        "button",
                        {
                ...
                (0, _renderField2.default)(_extends({}, schema.items, { showLabel: false }), idx.toString(), readOnly, theme, prefix, context),
...
var renderInput = function renderInput(field) {
    ...
    return _react2.default.createElement(
        ...
        renderArrayFields(field.fields.length, field.schema, field.readOnly, field.theme, field.fieldName, function (idx) {
            return field.fields.remove(idx);
        }, field.context, function (a, b) {
            field.fields.swap(a, b);
        }),
        !field.readOnly && (field.schema.maxItems ? field.fields.length < field.schema.maxItems : true) && _react2.default.createElement(
            "button",
            {
                type: "button",
