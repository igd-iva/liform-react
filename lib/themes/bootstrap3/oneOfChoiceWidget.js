    ...
    _createClass(OneOfChoiceWidget, [{
        ...
        value: function selectItem(e) {
            ...
            for (var property in schema.oneOf[this.state.choice].properties) {
                if (property === "@type") {
                    dispatch((0, _reduxForm.change)(context.formName, prefix + property, schema.oneOf[e.target.value].properties["@type"]["default"]));
                } else dispatch((0, _reduxForm.change)(context.formName, prefix + property, null));
            }
